...
import ThreeColGridEditing from './threecolgridediting';
import ThreeColGridUi from './threecolgridui';
import { Plugin } from 'ckeditor5/src/core';

export default class ThreeColGrid extends Plugin {
  ...
  static get requires() {
    return [ThreeColGridEditing, ThreeColGridUi];
  }
}
